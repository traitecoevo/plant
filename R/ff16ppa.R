...
##' Hyperparameters for FF16ppa physiological model
##' @title Hyperparameters for FF16ppa physiological model
...
##' @export
##' @rdname FF16ppa_hyperpar
make_FF16ppa_hyperpar <- function(
                                lma_0=0.1978791,
                                B_kl1=0.4565855,
                                B_kl2=1.71,
                                rho_0=608.0,
...
##' @export
FF16ppa_hyperpar <- make_FF16ppa_hyperpar()
