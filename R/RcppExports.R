...
Leaf__ctor <- function(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hk_s_, a, curv_fact_elec_trans, curv_fact_colim, B_rs1, B_lf2, B_lf3, B_lf5) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hk_s_, a, curv_fact_elec_trans, curv_fact_colim, B_rs1, B_lf2, B_lf3, B_lf5)
}
...
Leaf__set_physiology <- function(obj_, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area) {
    invisible(.Call('_plant_Leaf__set_physiology', PACKAGE = 'plant', obj_, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area))
}
...
Leaf__optimise_ci_Sperry_Newton <- function(obj_, ci_guess) {
    invisible(.Call('_plant_Leaf__optimise_ci_Sperry_Newton', PACKAGE = 'plant', obj_, ci_guess))
}
...
Leaf__calculate_cost_LCT <- function(obj_, psi_stem) {
    .Call('_plant_Leaf__calculate_cost_LCT', PACKAGE = 'plant', obj_, psi_stem)
}
...
Leaf__GSS_count__get <- function(obj_) {
    .Call('_plant_Leaf__GSS_count__get', PACKAGE = 'plant', obj_)
}

Leaf__GSS_count__set <- function(obj_, value) {
    invisible(.Call('_plant_Leaf__GSS_count__set', PACKAGE = 'plant', obj_, value))
}
...
FF16_Environment__get_vpd <- function(obj_) {
    .Call('_plant_FF16_Environment__get_vpd', PACKAGE = 'plant', obj_)
}
