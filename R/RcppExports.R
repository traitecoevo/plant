...
Leaf__find_root_psi <- function(obj_, wettest_soil_layer, psi_soil_seperate_, find_root_crit) {
    .Call('_plant_Leaf__find_root_psi', PACKAGE = 'plant', obj_, wettest_soil_layer, psi_soil_seperate_, find_root_crit)
}
