...
Leaf__ctor <- function(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hydraulic_turnover) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hydraulic_turnover)
}
...
Leaf__set_physiology <- function(obj_, k_s, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area) {
    invisible(.Call('_plant_Leaf__set_physiology', PACKAGE = 'plant', obj_, k_s, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area))
}
...
Leaf__k_s___get <- function(obj_) {
    .Call('_plant_Leaf__k_s___get', PACKAGE = 'plant', obj_)
}

Leaf__k_s___set <- function(obj_, value) {
    invisible(.Call('_plant_Leaf__k_s___set', PACKAGE = 'plant', obj_, value))
}
