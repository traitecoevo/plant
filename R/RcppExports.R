...
FF16_Environment__ctor <- function(canopy_rescale_usually, soil_number_of_depths, delta_z, K_sat, soil_moist_sat) {
    .Call('_plant_FF16_Environment__ctor', PACKAGE = 'plant', canopy_rescale_usually, soil_number_of_depths, delta_z, K_sat, soil_moist_sat)
}
