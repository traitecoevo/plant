...
FF16_Environment__ctor <- function(shading_spline_rescale_usually, soil_number_of_depths) {
    .Call('_plant_FF16_Environment__ctor', PACKAGE = 'plant', shading_spline_rescale_usually, soil_number_of_depths)
}

FF16_Environment__XXX_openness <- function(obj_, height) {
    .Call('_plant_FF16_Environment__XXX_openness', PACKAGE = 'plant', obj_, height)
}
...
K93_Environment__XXX_openness <- function(obj_, height) {
    .Call('_plant_K93_Environment__XXX_openness', PACKAGE = 'plant', obj_, height)
}
