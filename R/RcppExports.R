...
Leaf__ctor <- function(vcmax, p_50, c, b, psi_crit, K_s, epsilon_leaf, beta1, beta2) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax, p_50, c, b, psi_crit, K_s, epsilon_leaf, beta1, beta2)
}
