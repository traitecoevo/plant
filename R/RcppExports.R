...
FF16_Environment__compute_rates <- function(obj_, resource_consumption) {
    invisible(.Call('_plant_FF16_Environment__compute_rates', PACKAGE = 'plant', obj_, resource_consumption))
}
