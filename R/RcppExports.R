...
Leaf__ctor <- function(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value, K_s) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value, K_s)
}
