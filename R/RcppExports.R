...
Leaf__ctor <- function(vcmax, p_50, c, b, psi_crit, huber_value, K_s, epsilon_leaf) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax, p_50, c, b, psi_crit, huber_value, K_s, epsilon_leaf)
}
