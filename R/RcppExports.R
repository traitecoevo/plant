...
Leaf__ctor <- function(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax)
}
...
Leaf__set_physiology <- function(obj_, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area) {
    invisible(.Call('_plant_Leaf__set_physiology', PACKAGE = 'plant', obj_, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area))
}
