...
Leaf__ctor <- function(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter, g0, g1, g1_TF24) {
    .Call('_plant_Leaf__ctor', PACKAGE = 'plant', vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter, g0, g1, g1_TF24)
}
...
Leaf__set_physiology <- function(obj_, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa, theta_w, theta_fc, theta) {
    invisible(.Call('_plant_Leaf__set_physiology', PACKAGE = 'plant', obj_, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa, theta_w, theta_fc, theta))
}
...
Leaf__medlyn_stom_cond_minus_coupled_stom_cond <- function(obj_, x) {
    .Call('_plant_Leaf__medlyn_stom_cond_minus_coupled_stom_cond', PACKAGE = 'plant', obj_, x)
}
