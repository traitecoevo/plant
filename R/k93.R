# Built from  R/ff16r.R on Wed Aug 12 15:46:38 2020 using the scaffolder, from the strategy:  FF16r
...
##'
##' @export
K93_fixed_environment <- function(e=1.0, p = K93_Parameters(), height_max = 150.0) {
