...
##'   integral existed; it was re-anchored to hold p_50 fixed at the default
...
make_TF24_hyperpar <- function(lma_0=0.1978791,
                                ...
                                # p_50 from 2.889 to 3.593 MPa -- buying a height
                                # exponent and silently selling the vulnerability
                                # curve. Shifted by -0.2*log10(2.9782) so p_50 is
