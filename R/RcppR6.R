...
## Version: 0.2.4
## Hash: 79f1f462e4ba270b5ba398ac314e3fdc
...
`Leaf` <- function(vcmax_25, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax_25, hk_s_, a, curv_fact_elec_trans, curv_fact_colim, B_rs1, B_lf2, B_lf3, B_lf5) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax_25, hk_s_, a, curv_fact_elec_trans, curv_fact_colim, B_rs1, B_lf2, B_lf3, B_lf5)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      set_physiology = function(rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa) {
        Leaf__set_physiology(self, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa)
      },
      ...
      optimise_psi_stem_TF_newton = function(psi_guess) {
        Leaf__optimise_psi_stem_TF_newton(self, psi_guess)
      },
      calculate_cost_LCT = function(psi_stem) {
        Leaf__calculate_cost_LCT(self, psi_stem)
      }),
    active=list(
      ci_ = function(value) {
        if (missing(value)) {
