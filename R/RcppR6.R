...
## Version: 0.2.4
## Hash: c78b04c5a862e4394ab4c4853c28e61a
...
`Leaf` <- function(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value, K_s) {
  Leaf__ctor(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value, K_s)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
