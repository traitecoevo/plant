...
## Version: 0.2.4
## Hash: c27b220054a43fab0f3f69f7e606e763
...
`Leaf` <- function(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hk_s_, a, curv_fact_elec_trans, curv_fact_colim) {
  Leaf__ctor(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hk_s_, a, curv_fact_elec_trans, curv_fact_colim)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
