...
## Version: 0.2.4
## Hash: 4f13d2e017cf558ef3d83742f617b4bb
...
.R6_SCM___FF16__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      collect_errors = function(value) {
        if (missing(value)) {
          SCM___FF16__FF16_Env__collect_errors__get(self)
        } else {
          SCM___FF16__FF16_Env__collect_errors__set(self, value)
        }
      },
      ...
      combined_node_errors = function(value) {
        if (missing(value)) {
          SCM___FF16__FF16_Env__combined_node_errors__get(self)
        } else {
          stop("SCM<FF16,FF16_Env>$combined_node_errors is read-only")
        }
      }))
...
.R6_SCM___TF24__TF24_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      collect_errors = function(value) {
        if (missing(value)) {
          SCM___TF24__TF24_Env__collect_errors__get(self)
        } else {
          SCM___TF24__TF24_Env__collect_errors__set(self, value)
        }
      },
      net_reproduction_ratio_errors = function(value) {
        if (missing(value)) {
      ...
      combined_node_errors = function(value) {
        if (missing(value)) {
          SCM___TF24__TF24_Env__combined_node_errors__get(self)
        } else {
          stop("SCM<TF24,TF24_Env>$combined_node_errors is read-only")
        }
      }))
...
.R6_SCM___K93__K93_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      collect_errors = function(value) {
        if (missing(value)) {
          SCM___K93__K93_Env__collect_errors__get(self)
        } else {
          SCM___K93__K93_Env__collect_errors__set(self, value)
        }
      },
      net_reproduction_ratio_errors = function(value) {
        if (missing(value)) {
      ...
      combined_node_errors = function(value) {
        if (missing(value)) {
          SCM___K93__K93_Env__combined_node_errors__get(self)
        } else {
          stop("SCM<K93,K93_Env>$combined_node_errors is read-only")
        }
      }))
