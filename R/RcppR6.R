...
## Version: 0.2.4
## Hash: 39e71a9a9a114023312f52a1f5b80287
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      calc_profit_bartlett = function(PPFD, psi_soil, psi_stem, k_l_max, height) {
        Leaf__calc_profit_bartlett(self, PPFD, psi_soil, psi_stem, k_l_max, height)
      },
      optimise_profit_gss_bartlett = function(PPFD, psi_soil, height) {
        Leaf__optimise_profit_gss_bartlett(self, PPFD, psi_soil, height)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
