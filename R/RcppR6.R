...
## Version: 0.2.4
## Hash: 4370728bfa249089d013fbb74dc311d0
...
##' @export
`FF16_Environment` <- function(light_availability_spline_rescale_usually) {
  FF16_Environment__ctor(light_availability_spline_rescale_usually)
}
.R6_FF16_Environment <-
  R6::R6Class(
    "FF16_Environment",
