...
## Version: 0.2.4
## Hash: 8c4fa9b3c36ba032b81fd98248aeb881
...
##' 
##' @export
`Leaf` <- function(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter, g1_TF24, beta_R_H, beta_R_V) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter, g1_TF24, beta_R_H, beta_R_V)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      set_physiology = function(root_mass, rho, a_bio, PPFD, psi_soil, soil_depth, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa) {
        Leaf__set_physiology(self, root_mass, rho, a_bio, PPFD, psi_soil, soil_depth, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa)
      },
      ...
      E_from_Soil_to_Root_Collar = function(P_x_r, P_soil, dz, LA) {
        Leaf__E_from_Soil_to_Root_Collar(self, P_x_r, P_soil, dz, LA)
      },
      find_root_collar_psi = function() {
        Leaf__find_root_collar_psi(self)
      },
      find_root_psi = function(wettest_soil_layer, psi_soil_, find_root_crit) {
        Leaf__find_root_psi(self, wettest_soil_layer, psi_soil_, find_root_crit)
      },
      find_psi_stem_from_psi_root = function(psi_root, psi_soil_) {
        Leaf__find_psi_stem_from_psi_root(self, psi_root, psi_soil_)
      },
    ...
    active=list(
      ...
      root_mass_ = function(value) {
        if (missing(value)) {
          Leaf__root_mass___get(self)
        } else {
          Leaf__root_mass___set(self, value)
        }
      },
      c_r_V_total_ = function(value) {
        if (missing(value)) {
          Leaf__c_r_V_total___get(self)
        } else {
          Leaf__c_r_V_total___set(self, value)
        }
      },
      c_r_H_total_ = function(value) {
        if (missing(value)) {
          Leaf__c_r_H_total___get(self)
        } else {
          Leaf__c_r_H_total___set(self, value)
        }
      },
