...
## Version: 0.2.4
## Hash: 7691b0b9233df7527ef165407a05f45c
...
`Leaf` <- function(vcmax, p_50, c, b, psi_crit, K_s, epsilon_leaf, beta1, beta2) {
  Leaf__ctor(vcmax, p_50, c, b, psi_crit, K_s, epsilon_leaf, beta1, beta2)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
