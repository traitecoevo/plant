...
## Version: 0.2.4
## Hash: 9a172a359ef44e1fdbcf6fed7e4c12d5
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      convert_E_from_ci_to_psi_stem = function(E_ci) {
        Leaf__convert_E_from_ci_to_psi_stem(self, E_ci)
      },
      ...
      set_physiology = function(PPFD, psi_soil, k_l_max, atm_vpd, ca) {
        Leaf__set_physiology(self, PPFD, psi_soil, k_l_max, atm_vpd, ca)
      },
      optimise_ci_Sperry_one_line = function(max_ci) {
        Leaf__optimise_ci_Sperry_one_line(self, max_ci)
      },
      convert_psi_stem_to_ci_one_line = function(psi_stem) {
        Leaf__convert_psi_stem_to_ci_one_line(self, psi_stem)
      },
      get_leaf_states_rates_from_psi_stem_one_line = function(psi_stem) {
        Leaf__get_leaf_states_rates_from_psi_stem_one_line(self, psi_stem)
      },
      convert_psi_stem_to_ci = function(psi_stem) {
        Leaf__convert_psi_stem_to_ci(self, psi_stem)
      },
      get_leaf_states_rates_from_psi_stem = function(psi_stem) {
        Leaf__get_leaf_states_rates_from_psi_stem(self, psi_stem)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
