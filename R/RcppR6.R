...
## Version: 0.2.4
## Hash: 38d5bb048440ad6d35d107a2ed255a75
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      calc_cond_vuln = function(psi, k_l_max) {
        Leaf__calc_cond_vuln(self, psi, k_l_max)
      },
      ...
      calc_transp_diff = function(psi_stem, psi_soil, k_l_max, E) {
        Leaf__calc_transp_diff(self, psi_stem, psi_soil, k_l_max, E)
      },
      calc_psi_stem_ci = function(PPFD, psi_soil, k_l_max, E) {
        Leaf__calc_psi_stem_ci(self, PPFD, psi_soil, k_l_max, E)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
