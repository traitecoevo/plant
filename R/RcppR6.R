...
## Version: 0.2.4
## Hash: 567d8d6c9da183800e6fcb7d86da34e0
...
`Leaf` <- function(vcmax, p_50, c, b, psi_crit, K_s, epsilon_leaf) {
  Leaf__ctor(vcmax, p_50, c, b, psi_crit, K_s, epsilon_leaf)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      set_physiology = function(PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca) {
        Leaf__set_physiology(self, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca)
      },
