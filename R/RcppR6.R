...
## Version: 0.2.4
## Hash: 6260bfab88903939400072e56ed92e3a
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      set_physiology = function(mass_root_prop, rho, a_bio, PPFD, psi_soil, soil_depth, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa) {
        Leaf__set_physiology(self, mass_root_prop, rho, a_bio, PPFD, psi_soil, soil_depth, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa)
      },
      ...
      E_from_Soil_to_Root_Collar = function(P_x_r, P_soil) {
        Leaf__E_from_Soil_to_Root_Collar(self, P_x_r, P_soil)
      },
