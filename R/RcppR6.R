...
## Version: 0.2.4
## Hash: f0b0273657014bedc0c8749a64d518eb
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      set_physiology = function(PPFD, psi_soil, k_l_max, atm_vpd) {
        Leaf__set_physiology(self, PPFD, psi_soil, k_l_max, atm_vpd)
      },
      ...
      optimise_ci_Sperry_one_line = function(max_ci) {
        Leaf__optimise_ci_Sperry_one_line(self, max_ci)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
