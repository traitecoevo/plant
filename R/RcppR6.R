...
## Version: 0.2.4
## Hash: 71644e0ccba9a585f51910308dc64d06
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      set_physiology = function(rho, a_bio, PPFD, soil_moist, root_collar_psi, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa) {
        Leaf__set_physiology(self, rho, a_bio, PPFD, soil_moist, root_collar_psi, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area, leaf_temp, atm_o2_kpa, atm_kpa)
      },
      ...
      E_from_Soil_to_Root_Collar = function(P_x_r, P_soil, n_soil, z_soil_mid, dz, LA, c_r_H, c_r_VH, beta_R_H, beta_R_V) {
        Leaf__E_from_Soil_to_Root_Collar(self, P_x_r, P_soil, n_soil, z_soil_mid, dz, LA, c_r_H, c_r_VH, beta_R_H, beta_R_V)
      },
      find_root_collar_psi = function(soil_moist_) {
        Leaf__find_root_collar_psi(self, soil_moist_)
      },
      find_root_psi = function(wettest_soil_layer, psi_soil_seperate_, psi_leaf, find_root_crit) {
        Leaf__find_root_psi(self, wettest_soil_layer, psi_soil_seperate_, psi_leaf, find_root_crit)
      },
      find_psi_stem_from_psi_root = function(psi_root, psi_soil_seperate_) {
        Leaf__find_psi_stem_from_psi_root(self, psi_root, psi_soil_seperate_)
      },
    ...
    active=list(
      ...
      soil_moist_ = function(value) {
        if (missing(value)) {
          Leaf__soil_moist___get(self)
        } else {
          Leaf__soil_moist___set(self, value)
        }
      },
