...
## Version: 0.2.4
## Hash: 87ee86808943e12b50689966573bcc4e
...
`Leaf` <- function(vcmax_25, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
