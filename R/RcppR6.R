...
## Version: 0.2.4
## Hash: 4f62b03d5b56a0136e27e7a3bddd7116
...
##' @param delta_z Thickness of soil layers
##' @param soil_moist_sat Soil moisture at saturation
##' @param K_sat Saturated hydraulic conductivity
##' @param a_psi Coefficient for soil water potential
##' @param n_psi Exponent for soil water potential
##' @param b_infil Coefficient for infiltration
##' @param rainfall Rainfall amount
##' @param atm_vpd Atmospheric vapor pressure deficit
##' @param ca Atmospheric CO2 concentration
##' @param leaf_temp Leaf temperature
##' @param atm_o2_kpa Atmospheric O2 partial pressure
##' @param atm_kpa Atmospheric pressure
##' @rdname TF24_Environment
##' @export
`TF24_Environment` <- function(soil_number_of_depths, delta_z, soil_moist_sat, K_sat, a_psi, n_psi, b_infil) {
  TF24_Environment__ctor(soil_number_of_depths, delta_z, soil_moist_sat, K_sat, a_psi, n_psi, b_infil)
}
.R6_TF24_Environment <-
  R6::R6Class(
    "TF24_Environment",
