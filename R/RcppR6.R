...
## Version: 0.2.4
## Hash: ef0eebdc7c37d351a96630161d34680a
...
`Leaf` <- function(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value, K_s, epsilon_leaf) {
  Leaf__ctor(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value, K_s, epsilon_leaf)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      calc_vul_b = function() {
        Leaf__calc_vul_b(self)
      },
      calc_cond_vuln = function(psi) {
        Leaf__calc_cond_vuln(self, psi)
      },
      calc_E_supply = function(psi_stem) {
        Leaf__calc_E_supply(self, psi_stem)
      },
      calc_E_supply_full_integration = function(psi_stem) {
        Leaf__calc_E_supply_full_integration(self, psi_stem)
      },
      calc_g_c = function(psi_stem) {
        Leaf__calc_g_c(self, psi_stem)
      },
      calc_A_c = function(ci_) {
        Leaf__calc_A_c(self, ci_)
      },
      calc_A_j = function(ci_) {
        Leaf__calc_A_j(self, ci_)
      },
      calc_A_lim = function(ci_) {
        Leaf__calc_A_lim(self, ci_)
      },
      diff_ci = function(x, psi_stem) {
        Leaf__diff_ci(self, x, psi_stem)
      },
      calc_assim_gross = function(psi_stem) {
        Leaf__calc_assim_gross(self, psi_stem)
      },
      calc_hydraulic_cost_Sperry = function(psi_stem) {
        Leaf__calc_hydraulic_cost_Sperry(self, psi_stem)
      },
      calc_profit_Sperry = function(psi_stem) {
        Leaf__calc_profit_Sperry(self, psi_stem)
      },
      calc_hydraulic_cost_Bartlett = function(psi_stem) {
        Leaf__calc_hydraulic_cost_Bartlett(self, psi_stem)
      },
      calc_profit_Bartlett = function(psi_stem) {
        Leaf__calc_profit_Bartlett(self, psi_stem)
      },
      ...
      optimise_ci_Bartlett = function() {
        Leaf__optimise_ci_Bartlett(self)
      },
      calc_profit_Bartlett_ci = function(c_i) {
        Leaf__calc_profit_Bartlett_ci(self, c_i)
      },
      calc_assim_gross_ci = function(c_i) {
        Leaf__calc_assim_gross_ci(self, c_i)
      },
      calc_psi_stem_ci = function(E_ci) {
        Leaf__calc_psi_stem_ci(self, E_ci)
      },
      calc_psi_from_E = function(E_psi_stem) {
        Leaf__calc_psi_from_E(self, E_psi_stem)
      },
      calc_profit_Sperry_ci = function(c_i) {
        Leaf__calc_profit_Sperry_ci(self, c_i)
      },
      optimise_psi_stem_Sperry_Newton = function() {
        Leaf__optimise_psi_stem_Sperry_Newton(self)
      },
      optimise_psi_stem_Sperry_Newton_recall = function() {
        Leaf__optimise_psi_stem_Sperry_Newton_recall(self)
      },
      optimise_ci_Sperry_Newton = function() {
        Leaf__optimise_ci_Sperry_Newton(self)
      },
      optimise_ci_Sperry_Newton_recall = function() {
        Leaf__optimise_ci_Sperry_Newton_recall(self)
      },
      calc_min_psi = function() {
        Leaf__calc_min_psi(self)
      },
      min_psi = function(x_ci) {
        Leaf__min_psi(self, x_ci)
      },
      find_max_ci = function() {
        Leaf__find_max_ci(self)
      },
      optimise_psi_stem_Sperry_Newton_recall_one_line = function(psi_guess) {
        Leaf__optimise_psi_stem_Sperry_Newton_recall_one_line(self, psi_guess)
      },
      calc_j = function() {
        Leaf__calc_j(self)
      },
      calc_assim_gross_one_line = function(psi_stem) {
        Leaf__calc_assim_gross_one_line(self, psi_stem)
      },
      calc_profit_Sperry_one_line = function(psi_stem) {
        Leaf__calc_profit_Sperry_one_line(self, psi_stem)
      },
      optimise_ci_Sperry_Newton_recall_one_line = function(ci_guess) {
        Leaf__optimise_ci_Sperry_Newton_recall_one_line(self, ci_guess)
      },
      calc_profit_Sperry_ci_one_line = function(c_i) {
        Leaf__calc_profit_Sperry_ci_one_line(self, c_i)
      },
      calc_A_lim_one_line = function(c_i) {
        Leaf__calc_A_lim_one_line(self, c_i)
      },
      optimise_psi_stem_Sperry_one_line = function() {
        Leaf__optimise_psi_stem_Sperry_one_line(self)
      },
      set_physiology = function(PPFD, psi_soil, k_l_max) {
        Leaf__set_physiology(self, PPFD, psi_soil, k_l_max)
      },
      optimise_psi_stem_Sperry_Newton_recall_one_line_pass = function() {
        Leaf__optimise_psi_stem_Sperry_Newton_recall_one_line_pass(self)
      },
      find_max_ci_one_line = function() {
        Leaf__find_max_ci_one_line(self)
      },
      optimise_ci_Sperry_Newton_recall_one_line_max = function(ci_guess) {
        Leaf__optimise_ci_Sperry_Newton_recall_one_line_max(self, ci_guess)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
      ...
      psi_stem_next = function(value) {
        if (missing(value)) {
          Leaf__psi_stem_next__get(self)
        } else {
          Leaf__psi_stem_next__set(self, value)
        }
      },
      c_i_next = function(value) {
        if (missing(value)) {
          Leaf__c_i_next__get(self)
        } else {
          Leaf__c_i_next__set(self, value)
        }
      },
      ...
      j_ = function(value) {
        if (missing(value)) {
          ...
          Leaf__j___set(self, value)
        }
      },
      k_l_max_ = function(value) {
        if (missing(value)) {
          Leaf__k_l_max___get(self)
        } else {
          Leaf__k_l_max___set(self, value)
        }
      },
      ...
      opt_psi_stem = function(value) {
        if (missing(value)) {
          Leaf__opt_psi_stem__get(self)
        } else {
          Leaf__opt_psi_stem__set(self, value)
        }
      },
      opt_ci = function(value) {
        if (missing(value)) {
          Leaf__opt_ci__get(self)
        } else {
          Leaf__opt_ci__set(self, value)
        }
      }))
...
##' @export
`FF16_Environment` <- function(canopy_rescale_usually, soil_number_of_depths, PPFD_) {
  FF16_Environment__ctor(canopy_rescale_usually, soil_number_of_depths, PPFD_)
}
.R6_FF16_Environment <-
  R6::R6Class(
    "FF16_Environment",
    ...
    public=list(
      ...
      calc_n_psi = function() {
        FF16_Environment__calc_n_psi(self)
      },
      calc_a_psi = function() {
        FF16_Environment__calc_a_psi(self)
      },
      calc_psi = function(theta_) {
        FF16_Environment__calc_psi(self, theta_)
      },
      clear = function() {
