...
## Version: 0.2.4
## Hash: 520d042d062f98823007021962b13194
...
`Leaf` <- function(vcmax_25, c, b, psi_crit, beta1, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, newton_tol_abs, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, beta1, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, newton_tol_abs, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
...
##' @export
`FF16_Environment` <- function(canopy_rescale_usually, soil_number_of_depths, delta_z, K_sat, soil_moist_sat) {
  FF16_Environment__ctor(canopy_rescale_usually, soil_number_of_depths, delta_z, K_sat, soil_moist_sat)
}
.R6_FF16_Environment <-
  R6::R6Class(
    "FF16_Environment",
