...
## Version: 0.2.4
## Hash: b00f2a2ea604154ec37478e61e1d0d96
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      find_root_psi = function(wettest_soil_layer, psi_soil_seperate_, find_root_crit) {
        Leaf__find_root_psi(self, wettest_soil_layer, psi_soil_seperate_, find_root_crit)
      },
