...
## Version: 0.2.4
## Hash: cc0ac51334b5a864796f0a50e64cf02e
...
.R6_FF16_Environment <-
  R6::R6Class(
    ...
    public=list(
      ...
      set_shading_model = function(model, layer_optical_depth) {
        FF16_Environment__set_shading_model(self, model, layer_optical_depth)
      },
