...
## Version: 0.2.4
## Hash: 9be72d468aa974abcd29bbe13ffe58a5
...
`Leaf` <- function(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hydraulic_turnover) {
  Leaf__ctor(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hydraulic_turnover)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      set_physiology = function(k_s, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area) {
        Leaf__set_physiology(self, k_s, rho, a_bio, PPFD, psi_soil, leaf_specific_conductance_max, atm_vpd, ca, sapwood_volume_per_leaf_area)
      },
    ...
    active=list(
      ...
      k_s_ = function(value) {
        if (missing(value)) {
          Leaf__k_s___get(self)
        } else {
          Leaf__k_s___set(self, value)
        }
      },
      rho_ = function(value) {
        if (missing(value)) {
