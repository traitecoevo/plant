...
## Version: 0.2.4
## Hash: c716c351a0aa3212fa2796b1658ab1e2
...
OdeRunner <- function(T) {
  type <- c(T)
  valid <- list("OdeRunner<FF16>"="FF16", "OdeRunner<TF24>"="TF24", "OdeRunner<K93>"="K93")
  constructors <- list("OdeRunner<FF16>"=`OdeRunner<FF16>`, "OdeRunner<TF24>"=`OdeRunner<TF24>`, "OdeRunner<K93>"=`OdeRunner<K93>`)
