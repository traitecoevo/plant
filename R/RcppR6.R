...
## Version: 0.2.4
## Hash: 13cfb64b1212d92c4349588c73be6952
  ...
  R6::R6Class(
    ...
    public=list(
      ...
      establishment_probability = function(environment) {
        Plant___FF16__establishment_probability(self, environment)
      },
  ...
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(height) {
        Cohort___FF16__compute_competition(self, height)
      },
...
.R6_Species___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(height) {
        Species___FF16__compute_competition(self, height)
      },
      add_seed = function() {
      ...
      competition_effects_error = function(scal=1) {
        Species___FF16__competition_effects_error(self, scal)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
      ...
      competition_effects = function(value) {
        if (missing(value)) {
          Species___FF16__competition_effects__get(self)
        } else {
          stop("Species<FF16>$competition_effects is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
...
.R6_Patch___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(height) {
        Patch___FF16__compute_competition(self, height)
      },
      canopy_openness = function(height) {
  ...
  R6::R6Class(
    ...
    public=list(
      ...
      competition_effect_error = function(species_index) {
        SCM___FF16__competition_effect_error(self, species_index)
      },
...
.R6_StochasticSpecies___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(height) {
        StochasticSpecies___FF16__compute_competition(self, height)
      },
      add_seed = function() {
      ...
      establishment_probability = function(environment) {
        StochasticSpecies___FF16__establishment_probability(self, environment)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
...
.R6_StochasticPatch___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(height) {
        StochasticPatch___FF16__compute_competition(self, height)
      },
      canopy_openness = function(height) {
