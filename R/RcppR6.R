...
## Version: 0.2.4
## Hash: 941f83f15cbd0ff772fe9c9ed124d202
...
`Shading` <- function(tol, nbase, max_depth, rescale_usually) {
  Shading__ctor(tol, nbase, max_depth, rescale_usually)
}
.R6_Shading <-
  R6::R6Class(
    "Shading",
    ...
    public=list(
      ...
      canopy_openness = function(height) {
        Shading__canopy_openness(self, height)
      },
      clear = function() {
        Shading__clear(self)
      }),
    active=list(
      spline = function(value) {
        if (missing(value)) {
          Shading__spline__get(self)
        } else {
          Shading__spline__set(self, value)
        }
      }))
...
.R6_FF16_Environment <-
  R6::R6Class(
    ...
    active=list(
      ...
      shading = function(value) {
        if (missing(value)) {
          FF16_Environment__shading__get(self)
        } else {
          FF16_Environment__shading__set(self, value)
        }
      },
      soil = function(value) {
        if (missing(value)) {
...
.R6_K93_Environment <-
  R6::R6Class(
    ...
    active=list(
      ...
      shading = function(value) {
        if (missing(value)) {
          K93_Environment__shading__get(self)
        } else {
          K93_Environment__shading__set(self, value)
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
