...
## Version: 0.2.4
## Hash: 2ee021cf5adb4e44c393c7177ec36b6b
...
`Leaf` <- function(vcmax, p_50, c, b, psi_crit, huber_value, K_s, epsilon_leaf) {
  Leaf__ctor(vcmax, p_50, c, b, psi_crit, huber_value, K_s, epsilon_leaf)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      optimise_psi_stem_Sperry_Newton_one_line = function(psi_guess) {
        Leaf__optimise_psi_stem_Sperry_Newton_one_line(self, psi_guess)
      },
      calc_j = function() {
        Leaf__calc_j(self)
      },
      profit_psi_stem_Sperry_one_line = function(psi_stem) {
        Leaf__profit_psi_stem_Sperry_one_line(self, psi_stem)
      },
      ...
      optimise_ci_Sperry_Newton_one_line = function(ci_guess) {
        Leaf__optimise_ci_Sperry_Newton_one_line(self, ci_guess)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
      ...
      lambda_one_line_ = function(value) {
        if (missing(value)) {
          Leaf__lambda_one_line___get(self)
        } else {
          Leaf__lambda_one_line___set(self, value)
        }
      },
      j_ = function(value) {
        if (missing(value)) {
      ...
      method = function(value) {
        if (missing(value)) {
          Leaf__method__get(self)
        } else {
          Leaf__method__set(self, value)
        }
      },
