...
## Version: 0.2.4
## Hash: d388f7cf0ddf71289a7f7c38dbb28c72
...
`Leaf` <- function(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hk_s_) {
  Leaf__ctor(vcmax, c, b, psi_crit, epsilon_leaf, beta1, beta2, jmax, hk_s_)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
