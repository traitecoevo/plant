...
## Version: 0.2.4
## Hash: 2fcb6905f365d6c3fc63053216a9e1e8
  ...
  R6::R6Class(
    ...
    public=list(
      ...
      calc_k_l_max = function(K_s, h_v, h) {
        Leaf__calc_k_l_max(self, K_s, h_v, h)
      },
      calc_vul_b = function(p_50, c) {
        Leaf__calc_vul_b(self, p_50, c)
      },
      calc_cond_vuln = function(psi, k_l_max, b, c) {
        Leaf__calc_cond_vuln(self, psi, k_l_max, b, c)
      },
      calc_E_supply = function(k_l_max, b, c, psi_soil, psi_stem) {
        Leaf__calc_E_supply(self, k_l_max, b, c, psi_soil, psi_stem)
      },
      calc_g_c = function(psi_soil, psi_stem, k_l_max, p_50, c, b, atm_kpa, kg_2_mol_h2o, atm_vpd) {
        Leaf__calc_g_c(self, psi_soil, psi_stem, k_l_max, p_50, c, b, atm_kpa, kg_2_mol_h2o, atm_vpd)
      },
      calc_A_c = function(ci_, vcmax, gamma_25, umol_per_mol_2_Pa, km_25) {
        Leaf__calc_A_c(self, ci_, vcmax, gamma_25, umol_per_mol_2_Pa, km_25)
      },
      calc_A_j = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, ci_) {
        Leaf__calc_A_j(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, ci_)
      },
      calc_A_lim = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, ci_, km_25) {
        Leaf__calc_A_lim(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, ci_, km_25)
      },
      diff_ci = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, x, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa) {
        Leaf__diff_ci(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, x, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa)
      },
      calc_hydraulic_cost = function(psi_soil, psi_stem, k_l_max, b, c) {
        Leaf__calc_hydraulic_cost(self, psi_soil, psi_stem, k_l_max, b, c)
      },
      calc_assim_gross = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa) {
        Leaf__calc_assim_gross(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa)
      },
      calc_profit = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit) {
        Leaf__calc_profit(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit)
      },
      optimise_profit_gss = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit) {
        Leaf__optimise_profit_gss(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit)
      },
      calc_hydraulic_cost_bartlett = function(psi_soil, psi_stem, k_l_max, b, c, beta, beta_2, huber_value, height) {
        Leaf__calc_hydraulic_cost_bartlett(self, psi_soil, psi_stem, k_l_max, b, c, beta, beta_2, huber_value, height)
      },
      calc_profit_bartlett = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit, beta, beta_2, huber_value, height) {
        Leaf__calc_profit_bartlett(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit, beta, beta_2, huber_value, height)
      },
      optimise_profit_gss_bartlett = function(PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit, beta, beta_2, huber_value, height) {
        Leaf__optimise_profit_gss_bartlett(self, PPFD, vcmax, vcmax_25_2_jmax_25, curv_fact, a, gamma_25, umol_per_mol_2_Pa, km_25, psi_soil, k_l_max, p_50, c, b, kg_2_mol_h2o, umol_per_mol_2_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_2_Pa, psi_crit, beta, beta_2, huber_value, height)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
      ...
      g_c = function(value) {
        if (missing(value)) {
          ...
          Leaf__g_c__set(self, value)
        }
      },
      A_lim = function(value) {
        if (missing(value)) {
          Leaf__A_lim__get(self)
        } else {
          Leaf__A_lim__set(self, value)
        }
      },
      E = function(value) {
        if (missing(value)) {
      ...
      psi = function(value) {
        if (missing(value)) {
          ...
          Leaf__psi__set(self, value)
        }
      },
      profit = function(value) {
        if (missing(value)) {
          Leaf__profit__get(self)
        } else {
          Leaf__profit__set(self, value)
        }
      }))
...
.R6_Cohort___FF16__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      individual = function(value) {
        if (missing(value)) {
          Cohort___FF16__FF16_Env__individual__get(self)
        } else {
          stop("Cohort<FF16,FF16_Env>$individual is read-only")
        }
      },
...
.R6_Cohort___FF16w__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      individual = function(value) {
        if (missing(value)) {
          Cohort___FF16w__FF16_Env__individual__get(self)
        } else {
          stop("Cohort<FF16w,FF16_Env>$individual is read-only")
        }
      },
      height = function(value) {
        if (missing(value)) {
...
.R6_Cohort___FF16r__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      individual = function(value) {
        if (missing(value)) {
          Cohort___FF16r__FF16_Env__individual__get(self)
        } else {
          stop("Cohort<FF16r,FF16_Env>$individual is read-only")
        }
      },
      height = function(value) {
        if (missing(value)) {
...
.R6_Cohort___K93__K93_Env <-
  R6::R6Class(
    ...
    active=list(
      individual = function(value) {
        if (missing(value)) {
          Cohort___K93__K93_Env__individual__get(self)
        } else {
          stop("Cohort<K93,K93_Env>$individual is read-only")
        }
      },
      height = function(value) {
        if (missing(value)) {
...
.R6_Patch___FF16__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      cohort_ode_size = function(value) {
        if (missing(value)) {
          Patch___FF16__FF16_Env__cohort_ode_size__get(self)
        } else {
          stop("Patch<FF16,FF16_Env>$cohort_ode_size is read-only")
        }
      }))
...
.R6_Patch___FF16w__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      cohort_ode_size = function(value) {
        if (missing(value)) {
          Patch___FF16w__FF16_Env__cohort_ode_size__get(self)
        } else {
          stop("Patch<FF16w,FF16_Env>$cohort_ode_size is read-only")
        }
      }))
...
.R6_Patch___FF16r__FF16_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      cohort_ode_size = function(value) {
        if (missing(value)) {
          Patch___FF16r__FF16_Env__cohort_ode_size__get(self)
        } else {
          stop("Patch<FF16r,FF16_Env>$cohort_ode_size is read-only")
        }
      }))
...
.R6_Patch___K93__K93_Env <-
  R6::R6Class(
    ...
    active=list(
      ...
      cohort_ode_size = function(value) {
        if (missing(value)) {
          Patch___K93__K93_Env__cohort_ode_size__get(self)
        } else {
          stop("Patch<K93,K93_Env>$cohort_ode_size is read-only")
        }
      }))
