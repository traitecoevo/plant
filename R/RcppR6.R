...
## Version: 0.2.4
## Hash: d8253890b18236ed3a20521e2e66c023
...
Plant <- function(T) {
  type <- c(T)
  valid <- list("Plant<FF16>"="FF16", "Plant<FFdev>"="FFdev")
  constructors <- list("Plant<FF16>"=`Plant<FF16>`, "Plant<FFdev>"=`Plant<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
Parameters <- function(T) {
  type <- c(T)
  valid <- list("Parameters<FF16>"="FF16", "Parameters<FFdev>"="FFdev")
  constructors <- list("Parameters<FF16>"=`Parameters<FF16>`, "Parameters<FFdev>"=`Parameters<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
PlantPlus <- function(T) {
  type <- c(T)
  valid <- list("PlantPlus<FF16>"="FF16", "PlantPlus<FFdev>"="FFdev")
  constructors <- list("PlantPlus<FF16>"=`PlantPlus<FF16>`, "PlantPlus<FFdev>"=`PlantPlus<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
Cohort <- function(T) {
  type <- c(T)
  valid <- list("Cohort<FF16>"="FF16", "Cohort<FFdev>"="FFdev")
  constructors <- list("Cohort<FF16>"=`Cohort<FF16>`, "Cohort<FFdev>"=`Cohort<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
Species <- function(T) {
  type <- c(T)
  valid <- list("Species<FF16>"="FF16", "Species<FFdev>"="FFdev")
  constructors <- list("Species<FF16>"=`Species<FF16>`, "Species<FFdev>"=`Species<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
Patch <- function(T) {
  type <- c(T)
  valid <- list("Patch<FF16>"="FF16", "Patch<FFdev>"="FFdev")
  constructors <- list("Patch<FF16>"=`Patch<FF16>`, "Patch<FFdev>"=`Patch<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
EBT <- function(T) {
  type <- c(T)
  valid <- list("EBT<FF16>"="FF16", "EBT<FFdev>"="FFdev")
  constructors <- list("EBT<FF16>"=`EBT<FF16>`, "EBT<FFdev>"=`EBT<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
`EBT<FF16>` <- function(parameters) {
  EBT___FF16__ctor(parameters)
}
.R6_EBT___FF16 <-
  R6::R6Class(
    "EBT<FF16>",
    ...
    public=list(
      ...
      run = function() {
        EBT___FF16__run(self)
      },
      run_next = function() {
        EBT___FF16__run_next(self)
      },
      reset = function() {
        EBT___FF16__reset(self)
      },
      seed_rain = function(species_index) {
        EBT___FF16__seed_rain(self, species_index)
      },
      seed_rain_cohort = function(species_index) {
        EBT___FF16__seed_rain_cohort(self, species_index)
      },
      area_leaf_error = function(species_index) {
        EBT___FF16__area_leaf_error(self, species_index)
      },
      set_cohort_schedule_times = function(times) {
        EBT___FF16__set_cohort_schedule_times(self, times)
      }),
    active=list(
      complete = function(value) {
        if (missing(value)) {
          EBT___FF16__complete__get(self)
        } else {
          stop("EBT<FF16>$complete is read-only")
        }
      },
      time = function(value) {
        if (missing(value)) {
          EBT___FF16__time__get(self)
        } else {
          stop("EBT<FF16>$time is read-only")
        }
      },
      seed_rains = function(value) {
        if (missing(value)) {
          EBT___FF16__seed_rains__get(self)
        } else {
          stop("EBT<FF16>$seed_rains is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          EBT___FF16__parameters__get(self)
        } else {
          stop("EBT<FF16>$parameters is read-only")
        }
      },
      patch = function(value) {
        if (missing(value)) {
          EBT___FF16__patch__get(self)
        } else {
          stop("EBT<FF16>$patch is read-only")
        }
      },
      cohort_schedule = function(value) {
        if (missing(value)) {
          EBT___FF16__cohort_schedule__get(self)
        } else {
          EBT___FF16__cohort_schedule__set(self, value)
        }
      },
      ode_times = function(value) {
        if (missing(value)) {
          EBT___FF16__ode_times__get(self)
        } else {
          stop("EBT<FF16>$ode_times is read-only")
        }
      },
      state = function(value) {
        if (missing(value)) {
          EBT___FF16__state__get(self)
        } else {
          stop("EBT<FF16>$state is read-only")
        }
      },
      use_ode_times = function(value) {
        if (missing(value)) {
          EBT___FF16__use_ode_times__get(self)
        } else {
          EBT___FF16__use_ode_times__set(self, value)
        }
      },
      seed_rain_error = function(value) {
        if (missing(value)) {
          EBT___FF16__seed_rain_error__get(self)
        } else {
          stop("EBT<FF16>$seed_rain_error is read-only")
        }
      }))
...
StochasticSpecies <- function(T) {
  type <- c(T)
  valid <- list("StochasticSpecies<FF16>"="FF16", "StochasticSpecies<FFdev>"="FFdev")
  constructors <- list("StochasticSpecies<FF16>"=`StochasticSpecies<FF16>`, "StochasticSpecies<FFdev>"=`StochasticSpecies<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticPatch <- function(T) {
  type <- c(T)
  valid <- list("StochasticPatch<FF16>"="FF16", "StochasticPatch<FFdev>"="FFdev")
  constructors <- list("StochasticPatch<FF16>"=`StochasticPatch<FF16>`, "StochasticPatch<FFdev>"=`StochasticPatch<FFdev>`)
  constructors[[check_type(type, valid)]]
}
...
StochasticPatchRunner <- function(T) {
  type <- c(T)
  valid <- list("StochasticPatchRunner<FF16>"="FF16", "StochasticPatchRunner<FFdev>"="FFdev")
  constructors <- list("StochasticPatchRunner<FF16>"=`StochasticPatchRunner<FF16>`, "StochasticPatchRunner<FFdev>"=`StochasticPatchRunner<FFdev>`)
  constructors[[check_type(type, valid)]]
}
