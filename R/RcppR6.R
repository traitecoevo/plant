...
## Version: 0.2.4
## Hash: a6d3096ab0077cdc02d17df689ca6a50
...
##' 
##' @export
`Leaf` <- function(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter, g0, g1) {
  Leaf__ctor(vcmax_25, c, b, psi_crit, beta2, jmax_25, hk_s, a, curv_fact_elec_trans, curv_fact_colim, GSS_tol_abs, vulnerability_curve_ncontrol, ci_abs_tol, ci_niter, g0, g1)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      solve_medlyn_ci = function() {
        Leaf__solve_medlyn_ci(self)
      },
