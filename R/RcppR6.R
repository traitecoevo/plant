...
## Version: 0.2.4
## Hash: e40f6cf901f81f717ce0d6cd0df7368a
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      calc_profit_Sperry_ci_analytical = function(c_i) {
        Leaf__calc_profit_Sperry_ci_analytical(self, c_i)
      },
      A_lim_analytical = function(c_i) {
        Leaf__A_lim_analytical(self, c_i)
      },
      ...
      convert_psi_stem_to_ci_analytical = function(psi_stem) {
        Leaf__convert_psi_stem_to_ci_analytical(self, psi_stem)
      },
      get_leaf_states_rates_from_psi_stem_analytical = function(psi_stem) {
        Leaf__get_leaf_states_rates_from_psi_stem_analytical(self, psi_stem)
      },
    ...
    active=list(
      ...
      A_lim_ = function(value) {
        if (missing(value)) {
          Leaf__A_lim___get(self)
        } else {
          Leaf__A_lim___set(self, value)
        }
      },
      E = function(value) {
        if (missing(value)) {
