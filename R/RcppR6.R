...
## Version: 0.2.4
## Hash: 8af7cabaed2d2b7f1ed33d2c6fb7c1fa
...
`Leaf` <- function(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value) {
  Leaf__ctor(vcmax, p_50, c, b, psi_crit, beta, beta_2, huber_value)
}
.R6_Leaf <-
  R6::R6Class(
    "Leaf",
    ...
    public=list(
      ...
      calc_g_c = function(psi_soil, psi_stem, k_l_max, p_50, c, b, atm_kpa, kg_to_mol_h2o, atm_vpd) {
        Leaf__calc_g_c(self, psi_soil, psi_stem, k_l_max, p_50, c, b, atm_kpa, kg_to_mol_h2o, atm_vpd)
      },
      calc_A_c = function(ci_, vcmax, gamma_25, umol_per_mol_to_Pa, km_25) {
        Leaf__calc_A_c(self, ci_, vcmax, gamma_25, umol_per_mol_to_Pa, km_25)
      },
      calc_A_j = function(PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, ci_) {
        Leaf__calc_A_j(self, PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, ci_)
      },
      calc_A_lim = function(PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, ci_, km_25) {
        Leaf__calc_A_lim(self, PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, ci_, km_25)
      },
      diff_ci = function(PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, x, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa) {
        Leaf__diff_ci(self, PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, x, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa)
      },
      calc_hydraulic_cost = function(psi_soil, psi_stem, k_l_max, b, c) {
        Leaf__calc_hydraulic_cost(self, psi_soil, psi_stem, k_l_max, b, c)
      },
      calc_assim_gross = function(PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa) {
        Leaf__calc_assim_gross(self, PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa)
      },
      calc_profit = function(PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa, psi_crit) {
        Leaf__calc_profit(self, PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, km_25, psi_soil, psi_stem, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa, psi_crit)
      },
      optimise_profit_gss = function(PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, km_25, psi_soil, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa, psi_crit) {
        Leaf__optimise_profit_gss(self, PPFD, vcmax, vcmax_25_to_jmax_25, curv_fact, a, gamma_25, umol_per_mol_to_Pa, km_25, psi_soil, k_l_max, p_50, c, b, kg_to_mol_h2o, umol_per_mol_to_mol_per_mol, atm_vpd, ca, atm_kpa, kPa_to_Pa, psi_crit)
      },
      calc_hydraulic_cost_bartlett = function(psi_soil, psi_stem, k_l_max, height) {
        Leaf__calc_hydraulic_cost_bartlett(self, psi_soil, psi_stem, k_l_max, height)
      },
      calc_profit_bartlett = function(PPFD, psi_soil, psi_stem, height) {
        Leaf__calc_profit_bartlett(self, PPFD, psi_soil, psi_stem, height)
      },
      optimise_psi_stem = function(PPFD, psi_soil, height) {
        Leaf__optimise_psi_stem(self, PPFD, psi_soil, height)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
