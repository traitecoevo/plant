...
## Version: 0.2.4
## Hash: 0743f15ee776ad0526268f5623e9ed20
...
.R6_Leaf <-
  R6::R6Class(
    ...
    public=list(
      ...
      calc_E_supply = function(k_l_max, psi_soil, psi_stem) {
        Leaf__calc_E_supply(self, k_l_max, psi_soil, psi_stem)
      },
      calc_E_supply_full_integration = function(k_l_max, psi_soil, psi_stem) {
        Leaf__calc_E_supply_full_integration(self, k_l_max, psi_soil, psi_stem)
      },
      calc_g_c = function(psi_soil, psi_stem, k_l_max) {
        Leaf__calc_g_c(self, psi_soil, psi_stem, k_l_max)
      },
      calc_A_c = function(ci_) {
        Leaf__calc_A_c(self, ci_)
      },
      calc_A_j = function(PPFD, ci_) {
        Leaf__calc_A_j(self, PPFD, ci_)
      },
      calc_A_lim = function(PPFD, ci_) {
        Leaf__calc_A_lim(self, PPFD, ci_)
      },
      diff_ci = function(PPFD, x, psi_soil, psi_stem, k_l_max) {
        Leaf__diff_ci(self, PPFD, x, psi_soil, psi_stem, k_l_max)
      },
      calc_assim_gross = function(PPFD, psi_soil, psi_stem, k_l_max) {
        Leaf__calc_assim_gross(self, PPFD, psi_soil, psi_stem, k_l_max)
      },
      calc_hydraulic_cost_Sperry = function(psi_soil, psi_stem, k_l_max) {
        Leaf__calc_hydraulic_cost_Sperry(self, psi_soil, psi_stem, k_l_max)
      },
      calc_profit_Sperry = function(PPFD, psi_soil, psi_stem, k_l_max) {
        Leaf__calc_profit_Sperry(self, PPFD, psi_soil, psi_stem, k_l_max)
      },
      calc_hydraulic_cost_Bartlett = function(psi_soil, psi_stem, k_l_max) {
        Leaf__calc_hydraulic_cost_Bartlett(self, psi_soil, psi_stem, k_l_max)
      },
      calc_profit_Bartlett = function(PPFD, psi_soil, psi_stem, k_l_max) {
        Leaf__calc_profit_Bartlett(self, PPFD, psi_soil, psi_stem, k_l_max)
      },
      optimise_psi_stem_Bartlett = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_psi_stem_Bartlett(self, PPFD, psi_soil, k_l_max)
      },
      optimise_psi_stem_Sperry = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_psi_stem_Sperry(self, PPFD, psi_soil, k_l_max)
      },
      optimise_ci_Bartlett = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_ci_Bartlett(self, PPFD, psi_soil, k_l_max)
      },
      calc_profit_Bartlett_ci = function(PPFD, psi_soil, c_i, k_l_max) {
        Leaf__calc_profit_Bartlett_ci(self, PPFD, psi_soil, c_i, k_l_max)
      },
      calc_assim_gross_ci = function(PPFD, c_i) {
        Leaf__calc_assim_gross_ci(self, PPFD, c_i)
      },
      calc_psi_stem_ci = function(k_l_max, psi_soil, E_ci) {
        Leaf__calc_psi_stem_ci(self, k_l_max, psi_soil, E_ci)
      },
      calc_psi_from_E = function(E_psi_stem) {
        Leaf__calc_psi_from_E(self, E_psi_stem)
      },
      calc_profit_Sperry_ci = function(PPFD, psi_soil, c_i, k_l_max) {
        Leaf__calc_profit_Sperry_ci(self, PPFD, psi_soil, c_i, k_l_max)
      },
      optimise_psi_stem_Sperry_Newton = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_psi_stem_Sperry_Newton(self, PPFD, psi_soil, k_l_max)
      },
      optimise_psi_stem_Sperry_Newton_recall = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_psi_stem_Sperry_Newton_recall(self, PPFD, psi_soil, k_l_max)
      },
      optimise_ci_Sperry_Newton = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_ci_Sperry_Newton(self, PPFD, psi_soil, k_l_max)
      },
      optimise_ci_Sperry_Newton_recall = function(PPFD, psi_soil, k_l_max) {
        Leaf__optimise_ci_Sperry_Newton_recall(self, PPFD, psi_soil, k_l_max)
      }),
    active=list(
      ci = function(value) {
        if (missing(value)) {
