...
## Version: 0.2.4
## Hash: 7a6d0592758bdd58648264ff34b16fe2
...
.R6_Environment <-
  R6::R6Class(
    ...
    public=list(
      ...
      canopy_openness = function(size) {
        Environment__canopy_openness(self, size)
      },
  ...
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(h) {
        Plant___FF16__compute_competition(self, h)
      },
      compute_rates = function(environment) {
        Plant___FF16__compute_rates(self, environment)
      },
...
.R6_Cohort___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(size) {
        Cohort___FF16__compute_competition(self, size)
      },
      growth_rate_gradient = function(environment) {
        Cohort___FF16__growth_rate_gradient(self, environment)
      },
      compute_rates = function(environment) {
        Cohort___FF16__compute_rates(self, environment)
      },
    ...
    active=list(
      ...
      size = function(value) {
        if (missing(value)) {
          Cohort___FF16__size__get(self)
        } else {
          stop("Cohort<FF16>$size is read-only")
        }
      },
      ...
      competition_effect = function(value) {
        if (missing(value)) {
          Cohort___FF16__competition_effect__get(self)
        } else {
          stop("Cohort<FF16>$competition_effect is read-only")
        }
      },
...
.R6_Species___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_rates = function(environment) {
        Species___FF16__compute_rates(self, environment)
      },
      compute_competition = function(size) {
        Species___FF16__compute_competition(self, size)
      },
      add_seed = function() {
      ...
      competition_error = function(scal=1) {
        Species___FF16__competition_error(self, scal)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
      ...
      size_max = function(value) {
        if (missing(value)) {
          Species___FF16__size_max__get(self)
        } else {
          stop("Species<FF16>$size_max is read-only")
        }
      },
      sizes = function(value) {
        if (missing(value)) {
          Species___FF16__sizes__get(self)
        } else {
          Species___FF16__sizes__set(self, value)
        }
      },
      ...
      competition_effect = function(value) {
        if (missing(value)) {
          Species___FF16__competition_effect__get(self)
        } else {
          stop("Species<FF16>$competition_effect is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
...
.R6_Patch___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(size) {
        Patch___FF16__compute_competition(self, size)
      },
      canopy_openness = function(size) {
        Patch___FF16__canopy_openness(self, size)
      },
      ...
      compute_rates = function() {
        Patch___FF16__compute_rates(self)
      },
      reset = function() {
    ...
    active=list(
      ...
      size_max = function(value) {
        if (missing(value)) {
          Patch___FF16__size_max__get(self)
        } else {
          stop("Patch<FF16>$size_max is read-only")
        }
      },
...
.R6_SCM___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      competition_error = function(species_index) {
        SCM___FF16__competition_error(self, species_index)
      },
...
.R6_StochasticSpecies___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_rates = function(environment) {
        StochasticSpecies___FF16__compute_rates(self, environment)
      },
      compute_competition = function(size) {
        StochasticSpecies___FF16__compute_competition(self, size)
      },
      add_seed = function() {
    ...
    active=list(
      ...
      size_max = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16__size_max__get(self)
        } else {
          stop("StochasticSpecies<FF16>$size_max is read-only")
        }
      },
      sizes = function(value) {
        if (missing(value)) {
          StochasticSpecies___FF16__sizes__get(self)
        } else {
          StochasticSpecies___FF16__sizes__set(self, value)
        }
      },
...
.R6_StochasticPatch___FF16 <-
  R6::R6Class(
    ...
    public=list(
      ...
      compute_competition = function(size) {
        StochasticPatch___FF16__compute_competition(self, size)
      },
      canopy_openness = function(size) {
        StochasticPatch___FF16__canopy_openness(self, size)
      },
      add_seed = function(species_index) {
      ...
      compute_rates = function() {
        StochasticPatch___FF16__compute_rates(self)
      },
      reset = function() {
    ...
    active=list(
      ...
      size_max = function(value) {
        if (missing(value)) {
          StochasticPatch___FF16__size_max__get(self)
        } else {
          stop("StochasticPatch<FF16>$size_max is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
