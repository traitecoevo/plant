...
make_hyperpar <- function(strategy) {
  type = class(strategy)
  switch(type,
         FF16_Strategy=make_FF16_hyperpar,
         Water_Strategy=make_Water_hyperpar,
         FF16r_Strategy=make_FF16r_hyperpar,
         K93_Strategy=make_K93_hyperpar,
