...
#ifndef _TREE_RCPPR6_POST_HPP_
#define _TREE_RCPPR6_POST_HPP_

#include <Rcpp.h>
#include <tree/RcppR6_support.hpp>

namespace tree {
namespace RcppR6 {
namespace traits {
template <> inline std::string   class_name_r<tree::ode::test::Lorenz >() {return "Lorenz";}
template <> inline std::string   package_name<tree::ode::test::Lorenz >() {return "tree";}
template <> inline std::string generator_name<tree::ode::test::Lorenz >() {return ".R6_Lorenz";}
template <> inline std::string   class_name_r<tree::ode::test::OdeR >() {return "OdeR";}
template <> inline std::string   package_name<tree::ode::test::OdeR >() {return "tree";}
template <> inline std::string generator_name<tree::ode::test::OdeR >() {return ".R6_OdeR";}
template <> inline std::string   class_name_r<tree::ode::Runner<tree::ode::test::Lorenz> >() {return "OdeRunner<Lorenz>";}
template <> inline std::string   package_name<tree::ode::Runner<tree::ode::test::Lorenz> >() {return "tree";}
template <> inline std::string generator_name<tree::ode::Runner<tree::ode::test::Lorenz> >() {return ".R6_OdeRunner___Lorenz";}

template <> inline std::string   class_name_r<tree::ode::Runner<tree::ode::test::OdeR> >() {return "OdeRunner<OdeR>";}
template <> inline std::string   package_name<tree::ode::Runner<tree::ode::test::OdeR> >() {return "tree";}
template <> inline std::string generator_name<tree::ode::Runner<tree::ode::test::OdeR> >() {return ".R6_OdeRunner___OdeR";}

template <> inline std::string   class_name_r<tree::ode::Runner<tree::tools::PlantRunner> >() {return "OdeRunner<PlantRunner>";}
template <> inline std::string   package_name<tree::ode::Runner<tree::tools::PlantRunner> >() {return "tree";}
template <> inline std::string generator_name<tree::ode::Runner<tree::tools::PlantRunner> >() {return ".R6_OdeRunner___PlantRunner";}
template <> inline std::string   class_name_r<tree::CohortScheduleEvent >() {return "CohortScheduleEvent";}
template <> inline std::string   package_name<tree::CohortScheduleEvent >() {return "tree";}
template <> inline std::string generator_name<tree::CohortScheduleEvent >() {return ".R6_CohortScheduleEvent";}
template <> inline std::string   class_name_r<tree::CohortSchedule >() {return "CohortSchedule";}
template <> inline std::string   package_name<tree::CohortSchedule >() {return "tree";}
template <> inline std::string generator_name<tree::CohortSchedule >() {return ".R6_CohortSchedule";}
template <> inline std::string   class_name_r<tree::Disturbance >() {return "Disturbance";}
template <> inline std::string   package_name<tree::Disturbance >() {return "tree";}
template <> inline std::string generator_name<tree::Disturbance >() {return ".R6_Disturbance";}
template <> inline std::string   class_name_r<tree::Control >() {return "Control";}
template <> inline std::string   package_name<tree::Control >() {return "tree";}
template <> inline std::string generator_name<tree::Control >() {return "";}
template <> inline std::string   class_name_r<tree::ode::OdeControl >() {return "OdeControl";}
template <> inline std::string   package_name<tree::ode::OdeControl >() {return "tree";}
template <> inline std::string generator_name<tree::ode::OdeControl >() {return "";}
template <> inline std::string   class_name_r<tree::quadrature::QK >() {return "QK";}
template <> inline std::string   package_name<tree::quadrature::QK >() {return "tree";}
template <> inline std::string generator_name<tree::quadrature::QK >() {return ".R6_QK";}
template <> inline std::string   class_name_r<tree::quadrature::QAG >() {return "QAG";}
template <> inline std::string   package_name<tree::quadrature::QAG >() {return "tree";}
template <> inline std::string generator_name<tree::quadrature::QAG >() {return ".R6_QAG";}
template <> inline std::string   class_name_r<tree::interpolator::Interpolator >() {return "Interpolator";}
template <> inline std::string   package_name<tree::interpolator::Interpolator >() {return "tree";}
template <> inline std::string generator_name<tree::interpolator::Interpolator >() {return ".R6_Interpolator";}
template <> inline std::string   class_name_r<tree::Environment >() {return "Environment";}
template <> inline std::string   package_name<tree::Environment >() {return "tree";}
template <> inline std::string generator_name<tree::Environment >() {return ".R6_Environment";}
template <> inline std::string   class_name_r<tree::Plant_internals >() {return "Plant_internals";}
template <> inline std::string   package_name<tree::Plant_internals >() {return "tree";}
template <> inline std::string generator_name<tree::Plant_internals >() {return "";}
template <> inline std::string   class_name_r<tree::Plant<tree::FFW16_Strategy> >() {return "Plant<FFW16>";}
template <> inline std::string   package_name<tree::Plant<tree::FFW16_Strategy> >() {return "tree";}
template <> inline std::string generator_name<tree::Plant<tree::FFW16_Strategy> >() {return ".R6_Plant___FFW16";}
template <> inline std::string   class_name_r<tree::tools::PlantRunner >() {return "PlantRunner";}
template <> inline std::string   package_name<tree::tools::PlantRunner >() {return "tree";}
template <> inline std::string generator_name<tree::tools::PlantRunner >() {return ".R6_PlantRunner";}
template <> inline std::string   class_name_r<tree::FFW16_Strategy >() {return "FFW16_Strategy";}
template <> inline std::string   package_name<tree::FFW16_Strategy >() {return "tree";}
template <> inline std::string generator_name<tree::FFW16_Strategy >() {return "";}
template <> inline std::string   class_name_r<tree::FFW16_Parameters >() {return "FFW16_Parameters";}
template <> inline std::string   package_name<tree::FFW16_Parameters >() {return "tree";}
template <> inline std::string generator_name<tree::FFW16_Parameters >() {return "";}
template <> inline std::string   class_name_r<tree::FFW16_PlantPlus >() {return "FFW16_PlantPlus";}
template <> inline std::string   package_name<tree::FFW16_PlantPlus >() {return "tree";}
template <> inline std::string generator_name<tree::FFW16_PlantPlus >() {return ".R6_FFW16_PlantPlus";}
template <> inline std::string   class_name_r<tree::FFW16_PlantPlus::internals >() {return "FFW16_PlantPlus_internals";}
template <> inline std::string   package_name<tree::FFW16_PlantPlus::internals >() {return "tree";}
template <> inline std::string generator_name<tree::FFW16_PlantPlus::internals >() {return "";}
template <> inline std::string   class_name_r<tree::Cohort<tree::FFW16_Plant> >() {return "FFW16_Cohort";}
template <> inline std::string   package_name<tree::Cohort<tree::FFW16_Plant> >() {return "tree";}
template <> inline std::string generator_name<tree::Cohort<tree::FFW16_Plant> >() {return ".R6_FFW16_Cohort";}
template <> inline std::string   class_name_r<tree::Species<tree::FFW16_Plant> >() {return "FFW16_Species";}
template <> inline std::string   package_name<tree::Species<tree::FFW16_Plant> >() {return "tree";}
template <> inline std::string generator_name<tree::Species<tree::FFW16_Plant> >() {return ".R6_FFW16_Species";}
template <> inline std::string   class_name_r<tree::Patch<tree::FFW16_Plant> >() {return "FFW16_Patch";}
template <> inline std::string   package_name<tree::Patch<tree::FFW16_Plant> >() {return "tree";}
template <> inline std::string generator_name<tree::Patch<tree::FFW16_Plant> >() {return ".R6_FFW16_Patch";}
template <> inline std::string   class_name_r<tree::EBT<tree::FFW16_Plant> >() {return "FFW16_EBT";}
template <> inline std::string   package_name<tree::EBT<tree::FFW16_Plant> >() {return "tree";}
template <> inline std::string generator_name<tree::EBT<tree::FFW16_Plant> >() {return ".R6_FFW16_EBT";}
}
}
}
...
namespace Rcpp {
template <typename T>
SEXP wrap(const tree::RcppR6::RcppR6<T>& x) {
  return x.to_R6();
}

namespace traits {
template <typename T>
class Exporter<tree::RcppR6::RcppR6<T> > {
public:
  Exporter(SEXP x) : obj(tree::RcppR6::RcppR6<T>(x)) {}
  inline tree::RcppR6::RcppR6<T> get() { return obj; }
private:
  tree::RcppR6::RcppR6<T> obj;
};
}

template <> inline SEXP wrap(const tree::ode::test::Lorenz& x) {
  return wrap(tree::RcppR6::RcppR6<tree::ode::test::Lorenz>(x));
}
template <> inline tree::ode::test::Lorenz as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::ode::test::Lorenz>(x));
}
template <> inline SEXP wrap(const tree::ode::test::OdeR& x) {
  return wrap(tree::RcppR6::RcppR6<tree::ode::test::OdeR>(x));
}
template <> inline tree::ode::test::OdeR as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::ode::test::OdeR>(x));
}
template <> inline SEXP wrap(const tree::ode::Runner<tree::ode::test::Lorenz>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::ode::Runner<tree::ode::test::Lorenz> >(x));
}
template <> inline tree::ode::Runner<tree::ode::test::Lorenz> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::ode::Runner<tree::ode::test::Lorenz> >(x));
}

template <> inline SEXP wrap(const tree::ode::Runner<tree::ode::test::OdeR>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::ode::Runner<tree::ode::test::OdeR> >(x));
}
template <> inline tree::ode::Runner<tree::ode::test::OdeR> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::ode::Runner<tree::ode::test::OdeR> >(x));
}

template <> inline SEXP wrap(const tree::ode::Runner<tree::tools::PlantRunner>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::ode::Runner<tree::tools::PlantRunner> >(x));
}
template <> inline tree::ode::Runner<tree::tools::PlantRunner> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::ode::Runner<tree::tools::PlantRunner> >(x));
}
template <> inline SEXP wrap(const tree::CohortScheduleEvent& x) {
  return wrap(tree::RcppR6::RcppR6<tree::CohortScheduleEvent>(x));
}
template <> inline tree::CohortScheduleEvent as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::CohortScheduleEvent>(x));
}
template <> inline SEXP wrap(const tree::CohortSchedule& x) {
  return wrap(tree::RcppR6::RcppR6<tree::CohortSchedule>(x));
}
template <> inline tree::CohortSchedule as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::CohortSchedule>(x));
}
template <> inline SEXP wrap(const tree::Disturbance& x) {
  return wrap(tree::RcppR6::RcppR6<tree::Disturbance>(x));
}
template <> inline tree::Disturbance as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::Disturbance>(x));
}
template <> inline SEXP wrap(const tree::Control& x) {
  Rcpp::List ret;
...
template <> inline tree::Control as(SEXP x) {
  if (!tree::RcppR6::is<tree::Control >(x)) {
...
template <> inline SEXP wrap(const tree::ode::OdeControl& x) {
  Rcpp::List ret;
...
template <> inline tree::ode::OdeControl as(SEXP x) {
  if (!tree::RcppR6::is<tree::ode::OdeControl >(x)) {
    Rcpp::stop("Expected an object of type OdeControl");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  tree::ode::OdeControl ret;
  Rcpp::List xl(x);
...
template <> inline SEXP wrap(const tree::quadrature::QK& x) {
  return wrap(tree::RcppR6::RcppR6<tree::quadrature::QK>(x));
}
template <> inline tree::quadrature::QK as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::quadrature::QK>(x));
}
template <> inline SEXP wrap(const tree::quadrature::QAG& x) {
  return wrap(tree::RcppR6::RcppR6<tree::quadrature::QAG>(x));
}
template <> inline tree::quadrature::QAG as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::quadrature::QAG>(x));
}
template <> inline SEXP wrap(const tree::interpolator::Interpolator& x) {
  return wrap(tree::RcppR6::RcppR6<tree::interpolator::Interpolator>(x));
}
template <> inline tree::interpolator::Interpolator as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::interpolator::Interpolator>(x));
}
template <> inline SEXP wrap(const tree::Environment& x) {
  return wrap(tree::RcppR6::RcppR6<tree::Environment>(x));
}
template <> inline tree::Environment as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::Environment>(x));
}
template <> inline SEXP wrap(const tree::Plant_internals& x) {
  Rcpp::List ret;
...
template <> inline tree::Plant_internals as(SEXP x) {
  if (!tree::RcppR6::is<tree::Plant_internals >(x)) {
    Rcpp::stop("Expected an object of type Plant_internals");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  tree::Plant_internals ret;
  Rcpp::List xl(x);
...
template <> inline SEXP wrap(const tree::Plant<tree::FFW16_Strategy>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::Plant<tree::FFW16_Strategy> >(x));
}
template <> inline tree::Plant<tree::FFW16_Strategy> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::Plant<tree::FFW16_Strategy> >(x));
}
template <> inline SEXP wrap(const tree::tools::PlantRunner& x) {
  return wrap(tree::RcppR6::RcppR6<tree::tools::PlantRunner>(x));
}
template <> inline tree::tools::PlantRunner as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::tools::PlantRunner>(x));
}
template <> inline SEXP wrap(const tree::FFW16_Strategy& x) {
  Rcpp::List ret;
...
template <> inline tree::FFW16_Strategy as(SEXP x) {
  if (!tree::RcppR6::is<tree::FFW16_Strategy >(x)) {
    Rcpp::stop("Expected an object of type FFW16_Strategy");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  tree::FFW16_Strategy ret;
  Rcpp::List xl(x);
  ...
  ret.control = Rcpp::as<tree::Control >(xl["control"]);
  return ret;
}
template <> inline SEXP wrap(const tree::FFW16_Parameters& x) {
  Rcpp::List ret;
...
template <> inline tree::FFW16_Parameters as(SEXP x) {
  if (!tree::RcppR6::is<tree::FFW16_Parameters >(x)) {
    Rcpp::stop("Expected an object of type FFW16_Parameters");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  tree::FFW16_Parameters ret;
  Rcpp::List xl(x);
  ...
  ret.strategies = Rcpp::as<std::vector<tree::FFW16_Strategy> >(xl["strategies"]);
  ...
  ret.strategy_default = Rcpp::as<tree::FFW16_Strategy >(xl["strategy_default"]);
...
template <> inline SEXP wrap(const tree::FFW16_PlantPlus& x) {
  return wrap(tree::RcppR6::RcppR6<tree::FFW16_PlantPlus>(x));
}
template <> inline tree::FFW16_PlantPlus as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::FFW16_PlantPlus>(x));
}
template <> inline SEXP wrap(const tree::FFW16_PlantPlus::internals& x) {
  Rcpp::List ret;
...
template <> inline tree::FFW16_PlantPlus::internals as(SEXP x) {
  if (!tree::RcppR6::is<tree::FFW16_PlantPlus::internals >(x)) {
    Rcpp::stop("Expected an object of type FFW16_PlantPlus_internals");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  tree::FFW16_PlantPlus::internals ret;
  Rcpp::List xl(x);
...
template <> inline SEXP wrap(const tree::Cohort<tree::FFW16_Plant>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::Cohort<tree::FFW16_Plant> >(x));
}
template <> inline tree::Cohort<tree::FFW16_Plant> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::Cohort<tree::FFW16_Plant> >(x));
}
template <> inline SEXP wrap(const tree::Species<tree::FFW16_Plant>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::Species<tree::FFW16_Plant> >(x));
}
template <> inline tree::Species<tree::FFW16_Plant> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::Species<tree::FFW16_Plant> >(x));
}
template <> inline SEXP wrap(const tree::Patch<tree::FFW16_Plant>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::Patch<tree::FFW16_Plant> >(x));
}
template <> inline tree::Patch<tree::FFW16_Plant> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::Patch<tree::FFW16_Plant> >(x));
}
template <> inline SEXP wrap(const tree::EBT<tree::FFW16_Plant>& x) {
  return wrap(tree::RcppR6::RcppR6<tree::EBT<tree::FFW16_Plant> >(x));
}
template <> inline tree::EBT<tree::FFW16_Plant> as(SEXP x) {
  return *(tree::RcppR6::RcppR6<tree::EBT<tree::FFW16_Plant> >(x));
}
}
