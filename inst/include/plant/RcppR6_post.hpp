...
template <> inline std::string   class_name_r<odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> > >() {return "OdeRunner<TF24t>";}
template <> inline std::string   package_name<odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> > >() {return "plant";}
template <> inline std::string generator_name<odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> > >() {return ".R6_OdeRunner___TF24t";}
...
template <> inline std::string   class_name_r<plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "Individual<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_Individual___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "IndividualRunner<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_IndividualRunner___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "Parameters<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "";}
...
template <> inline std::string   class_name_r<plant::Node<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "Node<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::Node<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::Node<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_Node___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::Species<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "Species<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::Species<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::Species<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_Species___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "Patch<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_Patch___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "SCM<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_SCM___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "StochasticSpecies<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_StochasticSpecies___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "StochasticPatch<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_StochasticPatch___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "StochasticPatchRunner<TF24t,TF24_Env>";}
template <> inline std::string   package_name<plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment> >() {return "plant";}
template <> inline std::string generator_name<plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment> >() {return ".R6_StochasticPatchRunner___TF24t__TF24_Env";}
...
template <> inline std::string   class_name_r<plant::TF24t_Strategy >() {return "TF24t_Strategy";}
template <> inline std::string   package_name<plant::TF24t_Strategy >() {return "plant";}
template <> inline std::string generator_name<plant::TF24t_Strategy >() {return "";}
}
}
}
...
template <> inline SEXP wrap(const odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> >& x) {
  return wrap(plant::RcppR6::RcppR6<odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> > >(x));
}
template <> inline odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> > as(SEXP x) {
  return *(plant::RcppR6::RcppR6<odelia::ode::Solver<plant::tools::IndividualRunner<plant::TF24t_Strategy, plant::TF24_Environment> > >(x));
}
...
template <> inline SEXP wrap(const plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Individual<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::tools::IndividualRunner<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  Rcpp::List ret;
  ret["patch_area"] = Rcpp::wrap(x.patch_area);
  ret["n_patches"] = Rcpp::wrap(x.n_patches);
  ret["patch_type"] = Rcpp::wrap(x.patch_type);
  ...
  ret["initial_pr_patch_survival"] = Rcpp::wrap(x.initial_pr_patch_survival);
  ret["initial_time"] = Rcpp::wrap(x.initial_time);
  ret.attr("class") = Rcpp::CharacterVector::create("Parameters<TF24t,TF24_Env>", "Parameters");
  return ret;
}
template <> inline plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  if (!plant::RcppR6::is<plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment> >(x)) {
    Rcpp::stop("Expected an object of type Parameters<TF24t,TF24_Env>");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  plant::Parameters<plant::TF24t_Strategy,plant::TF24_Environment> ret;
  Rcpp::List xl(x);
  // ret.patch_area = Rcpp::as<decltype(retpatch_area) >(xl["patch_area"]);
  ret.patch_area = Rcpp::as<double >(xl["patch_area"]);
  // ret.n_patches = Rcpp::as<decltype(retn_patches) >(xl["n_patches"]);
  ...
  ret.max_patch_lifetime = Rcpp::as<double >(xl["max_patch_lifetime"]);
  // ret.strategies = Rcpp::as<decltype(retstrategies) >(xl["strategies"]);
  ret.strategies = Rcpp::as<std::vector<plant::TF24t_Strategy> >(xl["strategies"]);
  // ret.strategy_default = Rcpp::as<decltype(retstrategy_default) >(xl["strategy_default"]);
  ret.strategy_default = Rcpp::as<plant::TF24t_Strategy >(xl["strategy_default"]);
  // ret.node_schedule_times_default = Rcpp::as<decltype(retnode_schedule_times_default) >(xl["node_schedule_times_default"]);
  ret.node_schedule_times_default = Rcpp::as<std::vector<double> >(xl["node_schedule_times_default"]);
  // ret.node_schedule_times = Rcpp::as<decltype(retnode_schedule_times) >(xl["node_schedule_times"]);
  ret.node_schedule_times = Rcpp::as<std::vector<std::vector<double> > >(xl["node_schedule_times"]);
...
template <> inline SEXP wrap(const plant::Node<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Node<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::Node<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Node<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::Species<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Species<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::Species<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Species<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::Patch<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::SCM<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::StochasticSpecies<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::StochasticPatch<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment>& x) {
  return wrap(plant::RcppR6::RcppR6<plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
template <> inline plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment> as(SEXP x) {
  return *(plant::RcppR6::RcppR6<plant::StochasticPatchRunner<plant::TF24t_Strategy,plant::TF24_Environment> >(x));
}
...
template <> inline SEXP wrap(const plant::TF24t_Strategy& x) {
  Rcpp::List ret;
  ret["pars"] = Rcpp::wrap(x.pars);
  ret["control"] = Rcpp::wrap(x.control);
  ret["collect_all_auxiliary"] = Rcpp::wrap(x.collect_all_auxiliary);
  ...
  ret["birth_rate_y"] = Rcpp::wrap(x.birth_rate_y);
  ret["is_variable_birth_rate"] = Rcpp::wrap(x.is_variable_birth_rate);
  ret["topt_offset"] = Rcpp::wrap(x.topt_offset);
  ret["tcrit_0"] = Rcpp::wrap(x.tcrit_0);
  ret["k_d1_0"] = Rcpp::wrap(x.k_d1_0);
  ret["k_r1_0"] = Rcpp::wrap(x.k_r1_0);
  ret["m_switch"] = Rcpp::wrap(x.m_switch);
  ret["m_rep"] = Rcpp::wrap(x.m_rep);
  ret["t_rep_cut"] = Rcpp::wrap(x.t_rep_cut);
  ret["dTcrit_max"] = Rcpp::wrap(x.dTcrit_max);
  ret["dTopt_max"] = Rcpp::wrap(x.dTopt_max);
  ret["K_A"] = Rcpp::wrap(x.K_A);
  ret["alpha_opt"] = Rcpp::wrap(x.alpha_opt);
  ret["beta_opt"] = Rcpp::wrap(x.beta_opt);
  ret["t_accl_opt"] = Rcpp::wrap(x.t_accl_opt);
  ret["alpha_crit"] = Rcpp::wrap(x.alpha_crit);
...
template <> inline plant::TF24t_Strategy as(SEXP x) {
  if (!plant::RcppR6::is<plant::TF24t_Strategy >(x)) {
    Rcpp::stop("Expected an object of type TF24t_Strategy");
    // NOTE: Won't drop through or return anything.
  }
  // NOTE: assumes default constructable, and will assign *every*
  // field twice.  No current support for a hook.
  plant::TF24t_Strategy ret;
  Rcpp::List xl(x);
  // ret.pars = Rcpp::as<decltype(retpars) >(xl["pars"]);
  ret.pars = Rcpp::as<plant::TF24_Pars >(xl["pars"]);
  // ret.control = Rcpp::as<decltype(retcontrol) >(xl["control"]);
  ...
  // ret.is_variable_birth_rate = Rcpp::as<decltype(retis_variable_birth_rate) >(xl["is_variable_birth_rate"]);
  ret.is_variable_birth_rate = Rcpp::as<bool >(xl["is_variable_birth_rate"]);
  // ret.topt_offset = Rcpp::as<decltype(rettopt_offset) >(xl["topt_offset"]);
  ret.topt_offset = Rcpp::as<double >(xl["topt_offset"]);
  // ret.tcrit_0 = Rcpp::as<decltype(rettcrit_0) >(xl["tcrit_0"]);
  ret.tcrit_0 = Rcpp::as<double >(xl["tcrit_0"]);
  // ret.k_d1_0 = Rcpp::as<decltype(retk_d1_0) >(xl["k_d1_0"]);
  ret.k_d1_0 = Rcpp::as<double >(xl["k_d1_0"]);
  // ret.k_r1_0 = Rcpp::as<decltype(retk_r1_0) >(xl["k_r1_0"]);
  ret.k_r1_0 = Rcpp::as<double >(xl["k_r1_0"]);
  // ret.m_switch = Rcpp::as<decltype(retm_switch) >(xl["m_switch"]);
  ret.m_switch = Rcpp::as<double >(xl["m_switch"]);
  // ret.m_rep = Rcpp::as<decltype(retm_rep) >(xl["m_rep"]);
  ret.m_rep = Rcpp::as<double >(xl["m_rep"]);
  // ret.t_rep_cut = Rcpp::as<decltype(rett_rep_cut) >(xl["t_rep_cut"]);
  ret.t_rep_cut = Rcpp::as<double >(xl["t_rep_cut"]);
  // ret.dTcrit_max = Rcpp::as<decltype(retdTcrit_max) >(xl["dTcrit_max"]);
  ret.dTcrit_max = Rcpp::as<double >(xl["dTcrit_max"]);
  // ret.dTopt_max = Rcpp::as<decltype(retdTopt_max) >(xl["dTopt_max"]);
  ret.dTopt_max = Rcpp::as<double >(xl["dTopt_max"]);
  // ret.K_A = Rcpp::as<decltype(retK_A) >(xl["K_A"]);
  ret.K_A = Rcpp::as<double >(xl["K_A"]);
  // ret.alpha_opt = Rcpp::as<decltype(retalpha_opt) >(xl["alpha_opt"]);
  ret.alpha_opt = Rcpp::as<double >(xl["alpha_opt"]);
  // ret.beta_opt = Rcpp::as<decltype(retbeta_opt) >(xl["beta_opt"]);
  ret.beta_opt = Rcpp::as<double >(xl["beta_opt"]);
  // ret.t_accl_opt = Rcpp::as<decltype(rett_accl_opt) >(xl["t_accl_opt"]);
  ret.t_accl_opt = Rcpp::as<double >(xl["t_accl_opt"]);
  // ret.alpha_crit = Rcpp::as<decltype(retalpha_crit) >(xl["alpha_crit"]);
  ret.alpha_crit = Rcpp::as<double >(xl["alpha_crit"]);
  // ret.beta_crit = Rcpp::as<decltype(retbeta_crit) >(xl["beta_crit"]);
  ret.beta_crit = Rcpp::as<double >(xl["beta_crit"]);
  // ret.t_accl_crit = Rcpp::as<decltype(rett_accl_crit) >(xl["t_accl_crit"]);
