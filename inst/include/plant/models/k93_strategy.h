// Built from  inst/include/plant/models/ff16r_strategy.h on Wed Aug 12 15:46:38 2020 using the scaffolder, from the strategy:  FF16r
...
public:
  ...
  // Translate generic methods to K93 strategy leaf area methods
  ...
  void compute_rates(const K93_Environment& environment, bool reuse_intervals,
                Internals& vars);
  ...
  // that into Control or K93_Environment instead.
 ...
 // Baseline for growth mortality rate
  ...
  Assimilation<K93_Environment> assimilator;
