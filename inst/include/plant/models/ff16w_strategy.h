...
virtual std::vector<std::string> aux_names() {
  std::vector<std::string> ret(
      {"competition_effect", "net_mass_production_dt", "opt_psi_stem_","opt_ci_","profit_","assim_colimited_","hydraulic_cost_", "ci_","darea_leaf_dmass_live_", "stom_cond_CO2_", "transpiration_", "respiration_", "turnover_"});
