...
#include <plant/models/ff16r_environment.h>
#include <plant/models/assimilation.h>

namespace plant {

class FF16r_Strategy: public Strategy<FF16r_Environment> {
public:
  ...
  // Translate generic methods to FF16r strategy leaf area methods
  ...
  void compute_rates(const FF16r_Environment& environment, bool reuse_intervals,
                Internals& vars);
  ...
  double establishment_probability(const FF16r_Environment& environment);
  ...
  // that into Control or FF16r_Environment instead.
