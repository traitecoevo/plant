...
template <> SEXP wrap(const plant::ode::Runner<plant::tools::PlantRunner<plant::K93_Strategy, plant::K93_Environment> >&);
template <> plant::ode::Runner<plant::tools::PlantRunner<plant::K93_Strategy, plant::K93_Environment> > as(SEXP);
...
template <> SEXP wrap(const plant::Plant<plant::K93_Strategy,plant::K93_Environment>&);
template <> plant::Plant<plant::K93_Strategy,plant::K93_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::tools::PlantRunner<plant::K93_Strategy,plant::K93_Environment>&);
template <> plant::tools::PlantRunner<plant::K93_Strategy,plant::K93_Environment> as(SEXP);
