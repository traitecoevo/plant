...
template <> SEXP wrap(const plant::Cohort<plant::FF16w_Strategy,plant::FF16_Environment>&);
template <> plant::Cohort<plant::FF16w_Strategy,plant::FF16_Environment> as(SEXP);
