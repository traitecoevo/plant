...
template <> inline SEXP wrap(const tree2::Plant_internals& x) {
  ...
  ret["stem_area"] = Rcpp::wrap(x.stem_area);
  ...
  ret["stem_diameter"] = Rcpp::wrap(x.stem_diameter);
  ret["assimilation"] = Rcpp::wrap(x.assimilation);
  ret["respiration"] = Rcpp::wrap(x.respiration);
  ret["turnover"] = Rcpp::wrap(x.turnover);
  ret["net_mass_production"] = Rcpp::wrap(x.net_mass_production);
  ret["reproduction_mass_fraction"] = Rcpp::wrap(x.reproduction_mass_fraction);
  ret["growth_mass_fraction"] = Rcpp::wrap(x.growth_mass_fraction);
  ...
  ret["dstem_area_dt"] = Rcpp::wrap(x.dstem_area_dt);
  ret["dstem_diameter_dstem_area"] = Rcpp::wrap(x.dstem_diameter_dstem_area);
  ret["dstem_diameter_dt"] = Rcpp::wrap(x.dstem_diameter_dt);
...
template <> inline tree2::Plant_internals as(SEXP x) {
  ...
  // ret.stem_area = Rcpp::as<decltype(retstem_area) >(xl["stem_area"]);
  ret.stem_area = Rcpp::as<double >(xl["stem_area"]);
  ...
  // ret.stem_diameter = Rcpp::as<decltype(retstem_diameter) >(xl["stem_diameter"]);
  ret.stem_diameter = Rcpp::as<double >(xl["stem_diameter"]);
  ...
  // ret.net_mass_production = Rcpp::as<decltype(retnet_mass_production) >(xl["net_mass_production"]);
  ret.net_mass_production = Rcpp::as<double >(xl["net_mass_production"]);
  // ret.reproduction_mass_fraction = Rcpp::as<decltype(retreproduction_mass_fraction) >(xl["reproduction_mass_fraction"]);
  ret.reproduction_mass_fraction = Rcpp::as<double >(xl["reproduction_mass_fraction"]);
  // ret.growth_mass_fraction = Rcpp::as<decltype(retgrowth_mass_fraction) >(xl["growth_mass_fraction"]);
  ret.growth_mass_fraction = Rcpp::as<double >(xl["growth_mass_fraction"]);
  ...
  // ret.dstem_area_dt = Rcpp::as<decltype(retdstem_area_dt) >(xl["dstem_area_dt"]);
  ret.dstem_area_dt = Rcpp::as<double >(xl["dstem_area_dt"]);
  // ret.dstem_diameter_dstem_area = Rcpp::as<decltype(retdstem_diameter_dstem_area) >(xl["dstem_diameter_dstem_area"]);
  ret.dstem_diameter_dstem_area = Rcpp::as<double >(xl["dstem_diameter_dstem_area"]);
  // ret.dstem_diameter_dt = Rcpp::as<decltype(retdstem_diameter_dt) >(xl["dstem_diameter_dt"]);
  ret.dstem_diameter_dt = Rcpp::as<double >(xl["dstem_diameter_dt"]);
