...
```{r}
lma_attr <- 0.0825
patch_attr <- add_eq(lma_attr, params)

fitness_attr <- fitness_landscape(lma, patch_attr)
...
fitness_detail <- fitness_landscape(lma_detail, patch_attr)
...
```{r}
patch_eq_max <- add_eq(lma_max, fitness_attr)
