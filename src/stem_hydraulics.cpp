...
// Test-only entry point for the closed-form stem path integral (#615). Reachable
// as plant:::test_stem_effective_path_length(); `test_`-prefixed and not
...
// I7 bit-identity assertion cheap enough to run over a grid of heights.
