...
#pragma clang diagnostic pop
  ...
  Rcpp::class_<model::EBT>("EBT")
    .derives<ode::OdeTarget>("OdeTarget")
    .constructor<model::Parameters>()
    .method("seed_rain",         &model::EBT::r_seed_rain)
    .property("seed_rains",      &model::EBT::seed_rains)
    .method("seed_rain_error",   &model::EBT::r_seed_rain_error)
    .method("seed_rain_cohort",  &model::EBT::r_seed_rain_cohort)
