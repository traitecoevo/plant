...
void FF16r_Strategy::refresh_indices () {
...
void FF16r_Strategy::update_dependent_aux(const int index, Internals& vars) {
...
void FF16r_Strategy::compute_rates(const FF16r_Environment& environment,
...
double FF16r_Strategy::area_leaf_above(double z, double height) const {
