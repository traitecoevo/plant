...
RcppExport SEXP _plant_FF16_Environment__compute_rates(SEXP obj_SEXP, SEXP resource_consumptionSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< plant::RcppR6::RcppR6<plant::FF16_Environment> >::type obj_(obj_SEXP);
    Rcpp::traits::input_parameter< std::vector<std::vector<double>> >::type resource_consumption(resource_consumptionSEXP);
    FF16_Environment__compute_rates(obj_, resource_consumption);
    return R_NilValue;
END_RCPP
}
