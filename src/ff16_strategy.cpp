...
void FF16_Strategy::compute_rates(const environment_ptr& environment,
...
double FF16_Strategy::net_mass_production_dt(const environment_ptr& environment,
...
double FF16_Strategy::establishment_probability(const environment_ptr& environment) {
