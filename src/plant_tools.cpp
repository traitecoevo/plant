...
// [[Rcpp::export]]
plant::Internals FF16ppa_oderunner_plant_internals(
  const plant::ode::Runner<plant::tools::IndividualRunner<plant::FF16ppa_Strategy, plant::FF16_Environment>>& obj) {
  return obj.obj.plant.r_internals();
}
