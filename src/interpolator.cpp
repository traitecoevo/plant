...
Interpolator::Interpolator(bool is_akima, bool is_linear)
...
Rcpp::NumericMatrix Interpolator::r_get_xy() const {
...
Interpolator::select_interpolation_type(bool is_akima, bool is_linear) {
  if (is_linear) {
