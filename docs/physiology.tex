...
where
\begin{itemize}
\item $A_m$ is the maximum photosynthetic capacity of the leaf,
...
A_m = \beta_{lf1} \, \left(\frac{\nu}{\nu_0}\right)^{\beta_{lf5}},
\end{equation}
where $\beta_{lf1}$ and $\beta_{lf5}$ are constants. The relationships is normalized around $\nu_0$, the global mean of leaf nitrogen per unit area.
