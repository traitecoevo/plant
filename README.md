...
If you want to develop or extend `plant` (e.g. add a new strategy/model), see [agents.md](agents.md) and the *Implementing a new strategy* guide on [Overstorey](https://traitecoevo.github.io/overstorey/).
