...
```{r}
inputs <- expand_grid(rainfall = runif(10, min = 0.5, max = 3), p50_1 = runif(10, min = 0.1, max = 10), p50_2 = runif(10, min = 0.1, max = 10), initial_theta = c(0.01, 0.001), max_patch_lifetime = 2, schedule_eps = NA, ode_tol_abs = NA, ode_tol_rel = NA, epsilon_leaf = NA) %>%
  slice(sample(1:n()))  %>%
  slice(1:2)
```
