...
system.file("docs", "demography-vars.csv", package = "plant") %>%  read_csv() %>%
knitr::kable(align = "l",
...
compared to the control parameter `shading_spline_tol`. If
...
If the control parameter `assimilation_adaptive_integration` is `TRUE`,
the integration is performed using adaptive refinement with an accuracy
controlled by the parameter `assimilation_integration_tol`.
