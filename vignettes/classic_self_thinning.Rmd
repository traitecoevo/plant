...
2. We convert this output into a more manageable format to manipulate, and calculate totals and mean values for the properties of the stand.
...
```{r}
times <- c(tidy_stand$species$time[[10000]], tidy_stand$species$time[[10500]], tidy_stand$species$time[[12000]], tidy_stand$species$time[[13000]], tidy_stand$species$time[[13500]], tidy_stand$species$time[[14000]], tidy_stand$species$time[[15000]], tidy_stand$species$time[[17000]], tidy_stand$species$time[[20000]])
