...
This useses the dault parameters in plant. But you may want alter some of the deaults. For that we recommend setting up some functions to set `base_parameters`.
...
run_mypatch <- function(
  ...
  p1 <- expand_parameters(traits, p0, hyper_par_fn, mutant = FALSE, birth_rate_list = birth_rate_list)
