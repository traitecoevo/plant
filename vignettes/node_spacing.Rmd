...
![](figure/node_spacing__unnamed-chunk-2-1.png)
...
![](figure/node_spacing__unnamed-chunk-3-1.png)
...
![](figure/node_spacing__unnamed-chunk-4-1.png)
...
![](figure/node_spacing__unnamed-chunk-6-1.png)
...
![](figure/node_spacing__unnamed-chunk-7-1.png)
...
![](figure/node_spacing__unnamed-chunk-8-1.png)
...
![](figure/node_spacing__unnamed-chunk-9-1.png)
...
interpolated_shading_default <- sapply(results_default$env, interpolated_environment, heights)
interpolated_shading_insert <- sapply(results_insert$env, interpolated_environment, heights)

interpolated_shading_difference <- t(interpolated_shading_insert[, -(insert_position + 1)] - interpolated_shading_default)
interpolated_shading_difference[abs(interpolated_shading_difference) < 1e-10] <- NA
```
...
image(results_default$time, heights, interpolated_shading_difference,
      xlab="Time (years)", ylab="Height (m)", las=1, col=pal)
```

![](figure/node_spacing__unnamed-chunk-12-1.png)
XXX openness is
9.68%
...
![](figure/node_spacing__unnamed-chunk-13-1.png)
...
![](figure/node_spacing__unnamed-chunk-15-1.png)
...
![](figure/node_spacing__unnamed-chunk-16-1.png)
The refined node introduction schedule results in a seed rain near the
saturating value identified in [# Seed rain] but with 211
