...
interpolated_light_availability_default <- sapply(results_default$env, interpolated_environment, heights)
interpolated_light_availability_insert <- sapply(results_insert$env, interpolated_environment, heights)

interpolated_light_availability_difference <- t(interpolated_light_availability_insert[, -(insert_position + 1)] - interpolated_light_availability_default)
interpolated_light_availability_difference[abs(interpolated_light_availability_difference) < 1e-10] <- NA
```
...
image(results_default$time, heights, interpolated_light_availability_difference,
