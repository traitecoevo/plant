...
```{r}
tibble(psi_r = seq(P_x_r_UB_crit,-3.30,-0.01)) %>%
...
find_psi_leaf_from_root <- function(psi_root, E){
  leaf$set_physiology(PPFD = 1000, psi_soil = psi_root, leaf_specific_conductance_max = k_sw_max, atm_vpd = 2, ca = 40, sapwood_volume_per_leaf_area = 1.8e-04, rho = 608, a_bio = 0.0245, leaf_temp = 25, atm_o2_kpa = 21, atm_kpa = 101.3)
