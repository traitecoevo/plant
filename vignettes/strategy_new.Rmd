...
void compute_environment(Function f_compute_competition, double height_max) {
  ...
  auto f_XXX_openness = [&] (double height) -> double {return exp(-k_I * f_compute_competition(height));};
  environment_interpolator =
    environment_generator.construct(f_XXX_openness, lower_bound, upper_bound);
}
```
