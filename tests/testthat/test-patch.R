...
for (x in names(strategy_types)) {
 context(sprintf("Patch-%s",x))
  ...
  test_that("Basics", {
    ...
    ode_size <- Cohort(x, "FF16_Env")(s)$ode_size
    patch$add_seed(1)
