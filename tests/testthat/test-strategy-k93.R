...
test_that("K93 collect_all_auxillary option", {
  ...
  s <- K93_Strategy(collect_all_auxillary=TRUE)
...
test_that("K93_Strategy hyper-parameterisation", {
  ...
  # lma
  lma <- c(0.1,1)
  ret <- K93_hyperpar(trait_matrix(lma, "lma"), s)
  ...
  # wood density
  rho <- c(200,300)
  ret <- K93_hyperpar(trait_matrix(rho, "rho"), s)
  ...
  ret <- K93_hyperpar(trait_matrix(narea, "narea"), s)
  ...
  ret <- K93_hyperpar(trait_matrix(omega, "omega"), s)
  ...
  ## Empty trait matrix:
  ret <- K93_hyperpar(trait_matrix(numeric(0), "lma"), s)
