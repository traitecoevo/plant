...
test_that("Basic functions", {
  ...
  l <- Leaf(vcmax_25 = vcmax_25, jmax_25 = jmax_25, c = c, b = b, psi_crit = psi_crit, epsilon_leaf = 0.0001, beta1 = beta1, beta2= beta2, hk_s_ = hk_s_, a = a, curv_fact_elec_trans = curv_fact_elec_trans, curv_fact_colim = curv_fact_colim, B_rs1 = B_rs1, B_lf2 = B_lf2, B_lf3 = B_lf3, B_lf5 = B_lf5)
...
#  
  ...
  l <- Leaf(vcmax_25 = 50, jmax_25 = jmax_25, c = c, b = b, psi_crit = psi_crit, epsilon_leaf = 0.0001, beta1 = 5000, beta2= beta2, hk_s_ = hk_s_, a = a, curv_fact_elec_trans = curv_fact_elec_trans, curv_fact_colim = curv_fact_colim, B_rs1 = B_rs1, B_lf2 = B_lf2, B_lf3 = B_lf3, B_lf5 = B_lf5)
  l$set_physiology(PPFD = 1000, psi_soil = 0, leaf_specific_conductance_max = leaf_specific_conductance_max, atm_vpd = 1, ca = 40, sapwood_volume_per_leaf_area = sapwood_volume_per_leaf_area, rho = FF16w_strategy$rho, a_bio = FF16w_strategy$a_bio, leaf_temp = leaf_temp_, atm_o2_kpa = atm_o2_kpa_)
  l$optimise_psi_stem_TF()
  
  low_vcmax <- l$profit_
  
  l <- Leaf(vcmax_25 = 150, jmax_25 = jmax_25, c = c, b = b, psi_crit = psi_crit, epsilon_leaf = 0.0001, beta1 = 5000, beta2= beta2, hk_s_ = hk_s_, a = a, curv_fact_elec_trans = curv_fact_elec_trans, curv_fact_colim = curv_fact_colim, B_rs1 = B_rs1, B_lf2 = B_lf2, B_lf3 = B_lf3, B_lf5 = B_lf5)
  l$set_physiology(PPFD = 1000, psi_soil = 0, leaf_specific_conductance_max = leaf_specific_conductance_max, atm_vpd = 1, ca = 40, sapwood_volume_per_leaf_area = sapwood_volume_per_leaf_area, rho = FF16w_strategy$rho, a_bio = FF16w_strategy$a_bio, leaf_temp = leaf_temp_, atm_o2_kpa = atm_o2_kpa_)
  l$optimise_psi_stem_TF()
  ...
  l_low_temp <- Leaf(vcmax_25 = 50, jmax_25 = jmax_25, c = c, b = b, psi_crit = psi_crit, epsilon_leaf = 0.0001, beta1 = 5000, beta2= beta2, hk_s_ = hk_s_, a = a, curv_fact_elec_trans = curv_fact_elec_trans, curv_fact_colim = curv_fact_colim, B_rs1 = B_rs1, B_lf2 = B_lf2, B_lf3 = B_lf3, B_lf5 = B_lf5)
  ...
  l_ref_temp <- Leaf(vcmax_25 = 50, jmax_25 = jmax_25, c = c, b = b, psi_crit = psi_crit, epsilon_leaf = 0.0001, beta1 = 5000, beta2= beta2, hk_s_ = hk_s_, a = a, curv_fact_elec_trans = curv_fact_elec_trans, curv_fact_colim = curv_fact_colim, B_rs1 = B_rs1, B_lf2 = B_lf2, B_lf3 = B_lf3, B_lf5 = B_lf5)
  ...
  l_high_temp <- Leaf(vcmax_25 = 50, jmax_25 = jmax_25, c = c, b = b, psi_crit = psi_crit, epsilon_leaf = 0.0001, beta1 = 5000, beta2= beta2, hk_s_ = hk_s_, a = a, curv_fact_elec_trans = curv_fact_elec_trans, curv_fact_colim = curv_fact_colim, B_rs1 = B_rs1, B_lf2 = B_lf2, B_lf3 = B_lf3, B_lf5 = B_lf5)
